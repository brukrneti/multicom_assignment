...
<head>
    ...
    <title>Yeloo | All products</title>
        ...
        <div class="col-md-9" id="contentWrapper">
            ...
            <!--
                <div class="list-group">
                    <a href="#" class="list-group-item">Ornaments</a>
                    <a href="#" class="list-group-item">Toys</a>
                    <a href="#" class="list-group-item">Bowls</a>
                </div>
            </div>
            ...
            <div class="row">
                <div class=" col-xs-12 col-sm-4">
                    <form>
                        <div class="form-group">
                            <label for="selectCategory">Choose category to show:</label>
                            <select class="form-control" id="selectCategory">
                                <option value="all" selected>All products</option>
                                <option value="ornaments">Ornaments</option>
                                <option value="3dpuzzles">3D puzzles</option>
                ...
                <div class="col-xs-12 col-sm-6 col-sm-offset-2" style="margin-top: 5px;">
                    <p style="text-align: justify;">
                        <strong>NOTE: All the products are handemade in Croatia. All the oils used for finish protection are food-contact certified.
                        </strong>
                    </p>
                </div>
            </div>
